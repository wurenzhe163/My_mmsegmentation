...
data_root = 'data/my_dataset_2022_3q/'
img_norm_cfg = dict(
    mean=[59.2766, 61.479, 34.658], std=[39.5417, 30.968, 31.036], to_rgb=True)#mean=[59.2766, 61.479, 34.658], std=[39.5417, 30.968, 31.036]
img_scale = (512, 512)
crop_size = (256, 256)
train_pipeline = [
    dict(type='LoadImageFromFile_DelLastChannel',to_float32=True,imdecode_backend='tifffile'),
    ...
    dict(
        type='Normalize',
        mean=[59.2766, 61.479, 34.658], std=[39.5417, 30.968, 31.036],
        to_rgb=True),
...
train2=dict(
        type='ChaseDB1Dataset',
        data_root='data/my_dataset_2021_08/',
        img_dir='img_dir/train',
        ann_dir='ann_dir/train',
        pipeline=[
            dict(type='LoadImageFromFile_DelLastChannel',to_float32=True,imdecode_backend='tifffile'),
...
train3=dict(
        type='ChaseDB1Dataset',
        data_root='data/my_dataset_2016_12/',
        img_dir='img_dir/train',
        ann_dir='ann_dir/train',
        pipeline=[
            dict(type='LoadImageFromFile_DelLastChannel',to_float32=True,imdecode_backend='tifffile'),
